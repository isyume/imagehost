...
layui.define(['layer', 'laytpl', 'form', 'element','table'], function(exports){
  ...
  ,DISABLED = 'layui-btn-disabled';
	...
	console.group("欢迎光临云梦小店");
		console.log("地址：https://mall.iyume.top/product/");
		console.log("QQ交流群: 179149141");
		console.log("欢迎前来选购商品 或 进群交流");
	console.groupEnd();

	console.group("Copyright");
		console.log("Name：云梦网络科技");
		console.log("Official website：http://iyume.top/");
	console.groupEnd();
  //个人中心侧边导航
